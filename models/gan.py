...
Used as a visual feature (of unseen classes) generation model in TGG algorithm.
'''
...
class Regressor(nn.Module):
	'''
		The regressor for mapping the generated visual feature to the semantic feature (e.g., word vector or attribute)
	'''
